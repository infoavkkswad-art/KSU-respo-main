          ...
          <div className="grid lg:grid-cols-[1fr_400px] gap-12 items-start">
            <form onSubmit={submit} className="card p-8 bg-white border border-brand-brown/5 shadow-soft">
              <div className="flex items-center gap-4 mb-8 pb-6 border-b border-brand-brown/10">
                ...
                <div>
                  <h1 className="text-2xl font-serif font-bold text-brand-brown">Delivery Details & Payment</h1>
                  <p className="text-sm text-brand-brown/60">Provide your shipping information and complete secure payment.</p>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-brand-brown/10 flex flex-col sm:flex-row gap-4 items-center justify-between">
                ...
                <SubmitButton status={form.status} label="Proceed to Pay" />
              </div>
              <p className="mt-6 text-2xs text-brand-brown/50 text-center">Secure Razorpay payment gateway integration.</p>
            </form>
