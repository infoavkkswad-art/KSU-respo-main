...
exits successfully and does not write Mongo. Live pricing already
fail-closes nationwide destinations without this table.

Do not invent rows. Add owner-approved CSV rows first.
"""
...
async def import_parcel_zones() -> None:
...
if __name__ == "__main__":
    asyncio.run(import_parcel_zones())
